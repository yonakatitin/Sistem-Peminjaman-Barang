        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="car-details">
                    @if($detailbarang->gambar)
                    <div class="img rounded" style="background-image: url('{{ asset("storage/" . $detailbarang->gambar) }}');"></div>
                    @else
                    <div class="img rounded" style="background-image: url('{{ asset("assets/barang/default.png") }}');"></div>
                    @endif
                    <div class="text text-center">
                        <span class="subheading mb-2" style="color:black;">{{ $detailbarang->barang->unit->nama }}</span>
