...
<main>
    <div class="container-fluid px-4">
        <h2 class="mt-4">Edit Unit Peminjaman</h2>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <input class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" type="text" value="{{ $r->lokasi }}" />
