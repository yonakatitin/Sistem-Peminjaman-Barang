...
<main>
    <div class="container-fluid px-4">
        <h2 class="mt-4">Add Admin Unit</h2>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="/admin/adminunit">Admin Unit</a></li>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.adminunit.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row mb-3">
                        <div class="col-md-6">
